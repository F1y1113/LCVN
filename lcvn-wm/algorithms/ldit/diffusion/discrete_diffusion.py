...
class DiscreteDiffusion(nn.Module):
    ...
    def model_predictions(self, x, k, external_cond=None, external_cond_mask=None, i_clip=None):
        model_output = self.model(x, k, external_cond, external_cond_mask, i_clip)
    ...
    def p_mean_variance(self, x, k, external_cond=None, external_cond_mask=None, i_clip=None):
