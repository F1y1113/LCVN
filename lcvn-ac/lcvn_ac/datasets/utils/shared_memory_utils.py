...
try:
    from lcvn_ac.datasets.wm_shm_dataset import WMShmDataset
except Exception:
    class WMShmDataset:  # fallback placeholder to avoid hard import dependency
        pass
...
class SignalCallback(Callback):
    ...
    def on_fit_start(self, trainer: Trainer, pl_module: LightningModule) -> None:
        if isinstance(trainer.datamodule.train_dataloader()["vis"].dataset, WMShmDataset):  # type: ignore
